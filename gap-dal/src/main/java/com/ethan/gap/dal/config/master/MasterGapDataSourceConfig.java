package com.ethan.gap.dal.config.master;
...
public class MasterGapDataSourceConfig {
	protected static final String BASEPACKAGES = "com.ethan.gap.dal.dao.master";
	protected static final String MAPPER_LOCATION = "classpath:com/ethan/gap/dal/dao/master/*.xml";
