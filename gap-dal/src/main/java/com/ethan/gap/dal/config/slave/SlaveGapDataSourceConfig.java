package com.ethan.gap.dal.config.slave;
...
public class SlaveGapDataSourceConfig {
	protected static final String BASEPACKAGES = "com.ethan.gap.dal.dao.slave";
	protected static final String MAPPER_LOCATION = "classpath:com/ethan/gap/dal/dao/slave/*.xml";
